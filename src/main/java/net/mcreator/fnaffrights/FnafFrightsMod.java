 ...
 *
 */
package net.mcreator.fnaffrights;
...
@Mod("fnaf_frights")
public class FnafFrightsMod {
	public static final Logger LOGGER = LogManager.getLogger(FnafFrightsMod.class);
	public static final String MODID = "fnaf_frights";

	public FnafFrightsMod() {
		MinecraftForge.EVENT_BUS.register(this);
		FnafFrightsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		FnafFrightsModSounds.REGISTRY.register(bus);
		FnafFrightsModBlocks.REGISTRY.register(bus);
