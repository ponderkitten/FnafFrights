...
public class ASpringtrapActiveTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ASpringtrapActiveTileEntity(BlockPos pos, BlockState state) {
		super(FnafFrightsModBlockEntities.A_SPRINGTRAP_ACTIVE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ASpringtrapActiveTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ASpringtrapActiveTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("a_springtrap_active");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Angled Springtrap Showtime Active");
	}
