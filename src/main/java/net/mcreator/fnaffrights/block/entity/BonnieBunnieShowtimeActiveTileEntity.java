...
public class BonnieBunnieShowtimeActiveTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BonnieBunnieShowtimeActiveTileEntity(BlockPos pos, BlockState state) {
		super(FnafFrightsModBlockEntities.BONNIE_BUNNIE_SHOWTIME_ACTIVE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BonnieBunnieShowtimeActiveTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BonnieBunnieShowtimeActiveTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("bonnie_bunnie_showtime_active");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Bonnie The Bunnie Showtime Active");
	}
