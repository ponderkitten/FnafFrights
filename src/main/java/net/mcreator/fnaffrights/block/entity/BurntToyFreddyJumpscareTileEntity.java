...
public class BurntToyFreddyJumpscareTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BurntToyFreddyJumpscareTileEntity(BlockPos pos, BlockState state) {
		super(FnafFrightsModBlockEntities.BURNT_TOY_FREDDY_JUMPSCARE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BurntToyFreddyJumpscareTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BurntToyFreddyJumpscareTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("burnt_toy_freddy_jumpscare");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Burnt Toy Freddy Jumpscare");
	}
