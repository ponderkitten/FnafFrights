...
public class OffsetFoxyPirateActiveTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public OffsetFoxyPirateActiveTileEntity(BlockPos pos, BlockState state) {
		super(FnafFrightsModBlockEntities.OFFSET_FOXY_PIRATE_ACTIVE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<OffsetFoxyPirateActiveTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<OffsetFoxyPirateActiveTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("offset_foxy_pirate_active");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Offset Foxy The Pirate Showtime Active");
	}
