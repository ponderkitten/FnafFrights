...
public class ToyBonnieShowtimeActiveTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ToyBonnieShowtimeActiveTileEntity(BlockPos pos, BlockState state) {
		super(FnafFrightsModBlockEntities.TOY_BONNIE_SHOWTIME_ACTIVE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ToyBonnieShowtimeActiveTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ToyBonnieShowtimeActiveTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("toy_bonnie_showtime_active");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Toy Bonnie Showtime Active");
	}
