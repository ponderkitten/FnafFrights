package net.mcreator.fnaffrights.item.renderer;
...
import net.mcreator.fnaffrights.item.model.PresentItemModel;
import net.mcreator.fnaffrights.item.PresentItem;
import net.mcreator.fnaffrights.interfaces.RendersPlayerArms;
...
public class PresentItemRenderer extends GeoItemRenderer<PresentItem> implements RendersPlayerArms {
	public PresentItemRenderer() {
		super(new PresentItemModel());
	}

	@Override
	public RenderType getRenderType(PresentItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof PresentItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new PresentItemRenderer();
	...
	protected PresentItem animatable;
	...
	@Override
	public void render(GeoModel model, PresentItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(PresentItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(PresentItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(PresentItem animatable) {
